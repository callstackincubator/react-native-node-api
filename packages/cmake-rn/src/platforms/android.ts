...
export const platform = {
  ...
  options: [ndkVersionOption, androidSdkVersionOption] as const,
  configureArgs({ target, ndkVersion, sdkVersion }: AndroidConfigureOptions) {
...
} satisfies Platform<Target, Option[], Record<string, unknown>>;
